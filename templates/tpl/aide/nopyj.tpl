				...
				<div class=" col-md-1" role="complementary">
					<nav class="bs-docs-sidebar hidden-print hidden-sm hidden-xs affix"> 
						<ul class="nav bs-docs-sidenav target-active">
							<li><a href="#t1" id="page_menu_wiki" ><i class="fa fa-asterisk prune" aria-hidden="true"></i> Qu'est-ce que le rang "No-Pyj" ?</a></li>
							<li><a href="#t2" id="page_menu_wiki" ><i class="fa fa-asterisk ocean" aria-hidden="true"></i> Les conditions d'éligibilités</a></li>
